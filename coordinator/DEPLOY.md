...
machines** (desktop / laptop / your PC stay private, as nodes only).
...
## 4. Before it's truly public — hardening
...
*The coordinator moving to the cloud also means your desktop is no longer the network's
